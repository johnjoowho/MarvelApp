...
function renderResults2(data) { 
  ...
  <ol class="list of movies"> 
    <li class="movietitles">Title: "${data.results[0].title}"      Released: "${data.results[0].release_date}"      Popularity: ${data.results[0].popularity}</li>
      <div>
      <img class="topmovieimg" src="https://api.themoviedb.org/3/search/movie${data.results[0].poster_path}"> 
      </div> 
    <li class="movietitles">Title: "${data.results[1].title}"      Released: "${data.results[1].release_date}"      Popularity: ${data.results[1].popularity}</li>
    <li class="movietitles">Title: "${data.results[2].title}"      Released: "${data.results[2].release_date}"      Popularity: ${data.results[2].popularity}</li>
    <li class="movietitles">Title: "${data.results[3].title}"      Released: "${data.results[3].release_date}"      Popularity: ${data.results[3].popularity}</li>
    <li class="movietitles">Title: "${data.results[4].title}"      Released: "${data.results[4].release_date}"      Popularity: ${data.results[4].popularity}</li>
  </ol> 
  `
}
